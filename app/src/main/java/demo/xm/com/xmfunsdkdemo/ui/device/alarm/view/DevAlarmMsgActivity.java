...
/*              Event 对应的内容如下
                ...
                public final static String TYPE_IPC_ALARM = "IPCAlarm";//IPC报警
                ...
                public final static String TYPE_STORRAGE_LOW_SPACE = "StorrageLowSpace";//SD卡容量不足
                public final static String TYPE_FACE_RECFACE = "recface";  //ai算法 人脸识别
                public final static String TYPE_OFF_DUTY = "offduty";  //ai算法 离岗侦测
                public final static String TYPE_PET_DETECT = "PetDetect";  //宠物检测
                public final static String TYPE_CRY_DETECT = "CryDetect";//哭声检测
                public final static String TYPE_VOLUME_ALARM = "VolumeDetect"; // 异响检测
                public final static String TYPE_GSENSOR_ALARM = "GSensorAlarm"; //GSensor报警
                public final static String TYPE_PIR_ALARM = "PIRAlarm"; //移动侦测
                public final static String TYPE_INTERVAL_WAKE = "IntervalWakeAlarm"; //间隔唤醒
                public final static String TYPE_DOOR_LOCK_NOTIFY = "DoorLockNotify"; //门铃提醒
                public final static String TYPE_DOOR_LOCK_ALARM = "DoorLockAlarm"; //门锁告警
                public final static String TYPE_DOOR_BELL = "DoorLockCall"; //有客来访
                public final static String TYPE_RESERVER_WAKE = "ReserveWakeAlarm"; //预约唤醒
                public final static String TYPE_FORCE_DISMANTLE = "ForceDismantleAlarm";//防止强拆报警
                public final static String TYPE_LOW_BATTERY = "LowBatteryAlarm";//低电量
                public final static String TYPE_VIDEO_ANALYZE = "VideoAnalyze";//智能分析
                public final static String TYPE_HUMANE = "appEventHumanDetectAlarm";//人形检测
                public final static String TYPE_NOTICE_MSG = "Door_Noice_Msg";//门锁 通知消息
                public final static String TYPE_EXCEPTION_MSG = "Exception_Message";//门锁 异常消息
                public final static String TYPE_REMOTE_CALL_ALARM = "RemoteCallAlarm";//一键呼叫
                public final static String TYPE_REMOTE_FAMILY_CALL_OFF = "FamilyCallOff";//视频对讲挂断
                public final static String TYPE_REMOTE_FAMILY_CALL_ON = "FamilyCall";//视频对讲来电通知
                public final static String MSG_TYPE_VIDEO_TALK = "IncomingCall"; // 视频对讲
                public final static String TYPE_REMOTE_VOICE_CALL_OFF = "HangUp";//语音电话挂断
                public final static String TYPE_REMOTE_VOICE_CALL_ON = "IncomingCall";//语音电话来电通知
                public final static String MSG_TYPE_VOICE_TALK = "VoiceCall"; // 语音电话
                public final static String TYPE_CAR_SHAPE_DETECT = "CarShapeDetect";//车形检测
                public final static String TYPE_BIRD_ALARM = "BirdAlarm";//鸟识别
                public final static String TYPE_ANIMAL_ALARM = "HuntAlarm";//动物识别
                public final static String TYPE_TIME_ALBUM = "TimeAlbum"; // 时光相册
                public final static String TYPE_PARKING_PROTECTION = "ParkingProtection"; //车位守护
                public final static String TYPE_FIRE_DETECT = "FireDetection"; //烟火检测
                public final static String TYPE_PLAYBACK_QUICKLY = "TimeMicrocosm"; // 一日快放
                public final static String TYPE_FALL_DOWN_DETECTION = "FallDownDetection"; // 跌倒检测
                public final static String TYPE_PLAY_PHONE_DETECTION = "PlayPhoneMonitoring"; // 玩手机识别
                public final static String TYPE_PACKAGE_DETECTION = "Package";
                public final static String TYPE_SMOKING_DETECTION = "SmokingDetection"; // 吸烟检测
                public final static String TYPE_ELDERLY_CALL = "ElderlyCall"; // 老人看护呼叫
                public final static String TYPE_SLEEPER = "Sleeper"; // 久卧提醒
                public final static String TYPE_SEDENTARINESS = "Sedentariness"; //久坐提醒
                public final static String TYPE_LONG_TIME_DISAPPEAR = "LongTimeDisappear"; // 长时间未出现
                public final static String TYPE_HUMAN_FALL_DOWN = "HumanFallDown"; //  设备能力集 人形跌倒
                public final static String TYPE_NON_MOTOR_VEHICLE_DETECT = "NonMotorVehicleDetect"; //  	非机动车检测
                public final static String TYPE_NON_MOTOR_VEHICLE_PARKING = "NonMotorVehicleParking";// 非机动车停留
                public final static String TYPE_VEHICLE_PARKING = "VehicleParking";// VehicleParking  陌生车辆停留
                public final static String TYPE_PRIVATE_VEHICLE_PARKING = "PrivateVehicleParking";// 自家车辆停留
                public final static String TYPE_HIGH_TEMPERATURE = "HighTemperature"; // 高温报警
                public final static String TYPE_LOW_TEMPERATURE = "LowTemperature"; // 低温报警
                public final static String TYPE_OUTDOOR = "OutdoorSecurity"; // 室外安防
                public final static String TYPE_SLEEP_AT_WORK = "SleepAtWork"; // 睡岗检测
                public final static String TYPE_LABEL_DETECT = "LabelDetect"; // 标签检测
                public final static String TYPE_SUSPECTED_STRANGER = "SuspectedStranger"; // 疑似陌生人
                public final static String TYPE_VIEW_SUMMARY = "ViewSummary"; // 图生文（AI智述）
                public final static String TYPE_FEED_ERROR = "FeedAlarm";//喂食异常
                public final static String TYPE_FEED_LIMIT_ERROR = "FeedLimitError";//设备异常
                public final static String MSG_TYPE_DOOR_BELL = "DoorBell"; //有人按门铃
                public final static String MSG_TYPE_PASS_WD = "Passwd"; //密码开门
                public final static String MSG_TYPE_FINGER_PRINT = "FingerPrint"; //指纹开门
                public final static String MSG_TYPE_CARD = "Card"; //卡开门
                public final static String MSG_TYPE_KEY = "Key"; //钥匙开门
                public final static String MSG_TYPE_FINGER_PRINT_ERROR = "FingerPrintError"; //多次指纹输入错误
                public final static String MSG_TYPE_PASS_WD_ERROR = "PasswdError"; //多次密码输入错误
                public final static String MSG_TYPE_CARD_ERROR = "CardError"; //多次卡输入错误
                public final static String MSG_TYPE_FORCE_DEL_ALARM = "ForceDelAlarm"; //门锁正被暴力拆卸
                public final static String MSG_TYPE_TRESPASSING = "Trespassing"; //有人非法闯入
                public final static String MSG_TYPE_FORCE = "Force"; //胁迫警报
                public final static String MSG_TYPE_STAY_AWAY = "StayAlarm"; //逗留报警
                public final static String MSG_TYPE_LOW_BATTERY = "LowBattery"; //低电量报警
                public final static String MSG_TYPE_DOOR_LOCK_OPEN_COUNT = "DoorLockOpenCount"; //报警信息统计
                public final static String MSG_TYPE_FACE = "Face"; //人脸开门
                public final static String MSG_TYPE_TRIAL_ERROR = "TrialError"; // 试错报警
                public final static String MSG_TYPE_DOOR_CLOSE = "HasBeenClose";//门已关闭
                public final static String MSG_TYPE_DOOR_OPEN = "HasBeenOpen";//门已打开
                public final static String MSG_TYPE_REMOTE = "Remote";//远程开锁
                public final static String TYPE_SOMEONE_ENTERED = "SomeoneEntered"; //有人进入
                public final static String TYPE_SOMEONE_lEFT = "SomeoneLeft"; // 有人离开
                */
