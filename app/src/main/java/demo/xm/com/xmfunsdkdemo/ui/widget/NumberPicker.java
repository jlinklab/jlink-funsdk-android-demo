 ...
 * <ul>
 * <li>If the current theme is derived from {@link android.R.style#Theme} the
 * widget presents the current value as an editable input field with an
 * increment button above and a decrement button below. Long pressing the
 * buttons allows for a quick change of the current value. Tapping on the input
 * field allows to type in a desired value.</li>
 * <li>If the current theme is derived from {@link android.R.style#Theme_Holo}
 * or {@link android.R.style#Theme_Holo_Light} the widget presents the current
...
public class NumberPicker extends LinearLayout {
	...
	private boolean isNeedhangeColor;
	public void setisNeedhangeColor(boolean isNeedhangeColor){
		this.isNeedhangeColor = isNeedhangeColor;
	}
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mSelectionDividersDistance = attributesArray
				.getDimensionPixelSize(R.styleable.NumberPicker_selectionDividersDistance, defSelectionDividerDistance);
				...
				case MotionEvent.ACTION_HOVER_MOVE: {
					if (mLastHoveredChildVirtualViewId != hoveredVirtualViewId
						...
						provider.sendAccessibilityEventForVirtualView(hoveredVirtualViewId,
								AccessibilityEvent.TYPE_VIEW_HOVER_ENTER);
						mLastHoveredChildVirtualViewId = hoveredVirtualViewId;
						provider.performAction(hoveredVirtualViewId, AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS,
								null);
					}
				}
				break;
	...
	public EditText getmInputText(){
		return mInputText;
	}
	public void  setmInputText(EditText editText){
	...
	private boolean updateInputTextView() {
		...
		if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
			...
			if(!isNeedhangeColor){
				mInputText.setTextColor(getResources().getColor(R.color.app_theme_color));
			}
			return true;
		}
			...
			switch (virtualViewId) {
				...
				case VIRTUAL_VIEW_ID_DECREMENT:
					return createAccessibilityNodeInfoForVirtualButton(VIRTUAL_VIEW_ID_DECREMENT,
							...
							getScrollX() + (getRight() - getLeft()), mTopSelectionDividerTop + mSelectionDividerHeight);
